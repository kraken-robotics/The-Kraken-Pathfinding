...
/**
 * Classe qui permet de transférer les instructions du pathfinding au thread qui
 * s'en occupe
 * Cette classe notifie à la fois le thread qui fait le pathfinding (et qui
 * attend les instructions) et le thread
 * qui demande le pathfinding (et qui attend la notification de fin de
 * recherche)
 * 
 * @author pf
 *
...
public class PFInstruction implements Service, HighPFClass
{
	...
	private volatile boolean isSearching = false; // une recherche est-elle en
													// cours ?
