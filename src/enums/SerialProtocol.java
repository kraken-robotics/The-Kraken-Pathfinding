...
public enum SerialProtocol {
	...
	OUT_REMOVE_ALL_HOOKS(0x40),
	OUT_REMOVE_SOME_HOOKS(0x41),
	OUT_HOOK_DATE(0x44),
	OUT_HOOK_DEMI_PLAN(0x45),
	OUT_HOOK_POSITION(0x46),
	OUT_HOOK_POSITION_UNIQUE(0x47),
	...
	IN_DEBUT_MATCH(0x04),
	IN_MATCH_FINI(0x05),
	IN_COULEUR_ROBOT_SANS_SYMETRIE(0x06),
	IN_COULEUR_ROBOT_AVEC_SYMETRIE(0x07),
	IN_ROBOT_EN_MARCHE_AVANT(0x08),
	IN_ROBOT_EN_MARCHE_ARRIERE(0x09),
