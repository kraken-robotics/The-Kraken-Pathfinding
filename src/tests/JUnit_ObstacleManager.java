...
public class JUnit_ObstacleManager extends JUnit_Test {
    ...
    public void test_creation() throws Exception
    {
    	...
    	obstaclemanager.creerObstacle(new Vec2(500, 500), 0);
    	Assert.assertTrue(obstaclemanager.nbObstaclesMobiles() == 1);
    	obstaclemanager.creerObstacle(new Vec2(-20, 10), 0);
    	Assert.assertTrue(obstaclemanager.nbObstaclesMobiles() == 2);
    	obstaclemanager.creerObstacle(new Vec2(5000, 200), 0);
    ...
    {
    	Assert.assertTrue(!obstaclemanager.isObstacleFixePresentCapteurs(new Vec2(500, 500)));
    	Assert.assertTrue(obstaclemanager.isObstacleFixePresentCapteurs(new Vec2(30, 30)));
    	
    	// Vérification de la présence d'obstacles mobiles
    	Assert.assertTrue(!obstaclemanager.isObstacleMobilePresent(new Vec2(500, 500), 1));
    	Assert.assertTrue(!obstaclemanager.isObstacleMobilePresent(new Vec2(520, 520), 100));
    	obstaclemanager.creerObstacle(new Vec2(500, 500), 0);
    	Assert.assertTrue(obstaclemanager.isObstacleMobilePresent(new Vec2(500, 500), 1));
    	Assert.assertTrue(obstaclemanager.isObstacleMobilePresent(new Vec2(520, 520), 100));
    }
    ...
    public void test_peremption() throws Exception
    {
    	...
    	obstaclemanager.creerObstacle(new Vec2(0, 0), 0);
    	obstaclemanager.creerObstacle(new Vec2(500, 500), 0);
    	obstaclemanager.creerObstacle(new Vec2(0, 0), 0);
    	Assert.assertTrue(obstaclemanager.isObstacleMobilePresent(new Vec2(500, 500), 1));
    ...
    {
    	Assert.assertTrue(obstaclemanager.obstacleFixeDansSegmentPathfinding(new Vec2(-1000, 30), new Vec2(1000, 30)));
    	Assert.assertTrue(!obstaclemanager.obstacleFixeDansSegmentPathfinding(new Vec2(500, 500), new Vec2(800, 800)));
    }
    ...
    public void test_collision_obstacle_mobile() throws Exception
    {
    	...
    	Assert.assertTrue(!obstaclemanager.obstacleProximiteDansSegment(new Vec2(100, 100), new Vec2(900, 900), 0));
    	obstaclemanager.creerObstacle(new Vec2(-300, 500), 0);
    	Assert.assertTrue(!obstaclemanager.obstacleProximiteDansSegment(new Vec2(100, 100), new Vec2(900, 900), 0));
    	obstaclemanager.creerObstacle(new Vec2(1300, 1300), 0);
    	Assert.assertTrue(!obstaclemanager.obstacleProximiteDansSegment(new Vec2(100, 100), new Vec2(900, 900), 0));
    	obstaclemanager.creerObstacle(new Vec2(400, 500), 0);
    }
    @Test
    public void test_peremption_en_mouvement() throws Exception
    {
    	...
    	obstaclemanager.updateConfig();
    	obstaclemanager.creerObstacle(new Vec2(1200, 900), 0);
    	// Le temps qu'on y arrive, il devrait être périmé
    	Assert.assertTrue(!obstaclemanager.obstacleProximiteDansSegment(new Vec2(-1200, 100), new Vec2(1200, 900), 0));
    }
    ...
    public void test_ennemi_dans_element_jeu() throws Exception
    {
    	...
    	obstaclemanager.creerObstacle(new Vec2(1500, 150), 0);
