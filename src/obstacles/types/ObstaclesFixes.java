...
public enum ObstaclesFixes
{
	...
	PETIT_CRATERE_HAUT_GAUCHE(new ObstacleCircular(new Vec2RO(650 - 1500, 2000 - 550), 125, Couleur.OBSTACLES), false, false),
	PETIT_CRATERE_HAUT_DROITE(new ObstacleCircular(new Vec2RO(1500 - 650, 2000 - 550), 125, Couleur.OBSTACLES), false, false),
