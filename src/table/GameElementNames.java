...
{
	MINERAI_CRATERE_HAUT_GAUCHE(new ObstacleCircular(new Vec2RO(650 - 1500, 2000 - 540), 125, Couleur.GAME_ELEMENT), -Math.PI / 2, new Double[]{-Math.PI, 0., 2.6, Math.PI}),
	MINERAI_CRATERE_HAUT_DROITE(new ObstacleCircular(new Vec2RO(1500 - 650, 2000 - 540), 125, Couleur.GAME_ELEMENT), -Math.PI / 2, new Double[]{-Math.PI, 0.54}),
