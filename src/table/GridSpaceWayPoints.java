...
public class GridSpaceWayPoints implements Service {
...
//			log.debug("Pas de problème entre "+i+" et "+j, this);
	 ...
	 * @param date
	 */
	public void copy(GridSpaceWayPoints other, long date)
	{
...
// 300
	 ...
	 * @return
	 */
	public GridSpaceWayPoints clone(long date)
	{
		GridSpaceWayPoints cloned_gridspace = new GridSpaceWayPoints(log, obstaclemanager.clone(), notifieur);
