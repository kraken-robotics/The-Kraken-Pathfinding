...
public enum ConfigInfo {
	...
	PF_MARGE_AVANT_COLLISION((int)(100/ClothoidesComputer.PRECISION_TRACE_MM)), // combien de points de pathfinding retire-t-on avant la collision
	...
	TAILLE_FAISCEAU_PF(20), // combien de voisins sont ajoutés à l'openset à chaque itération // TODO
